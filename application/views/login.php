        ...
        <div class="header-body text-center mb-3">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white"><?php $info = $this->Admin_model->table_column('profile_setting');
             foreach($info as $row){ 
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <form role="form" method="post" action="<?php echo base_url(); ?>Admin/login/administration">
          ...
          <div class="row " style="padding:10px;background-color:#825ee4;">
            <div class="col-6">
