  ...
  <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        ...
        <?php $info = $this->Admin_model->table_column('profile_setting');
             foreach($info as $row){ 
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          <!-- Nav items -->
          <ul class="navbar-nav">
          <li class="nav-item <?php if($this->uri->segment(2) == ''){ ?>active_live <?php } ?>">
              <a class="nav-link active" href="<?php echo base_url(); ?>">
                <i class="ni ni-tv-2 text-primary"></i>
                <span class="nav-link-text">Dashboard</span>
              </a>
            </li>
            <li class="nav-item <?php if($this->uri->segment(2) == 'customer'){ ?>active_live <?php } ?>">
              <a class="nav-link" href="<?php echo base_url(); ?>View/customer/list_customer">
                <i class="ni ni-tag text-orange"></i>
                <span class="nav-link-text">Customer</span>
              </a>
            </li>
            <li class="nav-item  <?php if($this->uri->segment(2) == 'employee'){ ?>active_live <?php } ?>">
              <a class="nav-link" href="<?php echo base_url(); ?>View/employee/list_employee">
                <i class="ni ni-tag text-primary"></i>
                <span class="nav-link-text">Employee</span>
              </a>
            </li>
            <li class="nav-item  <?php if($this->uri->segment(2) == 'supplier'){ ?>active_live <?php } ?>">
              <a class="nav-link" href="<?php echo base_url(); ?>View/supplier/list_supplier">
          ...
          <li class="nav-item <?php if($this->uri->segment(3) == 'profile'){ ?>active_live <?php } ?>">
              <a class="nav-link" href="<?php echo base_url(); ?>View/setting/profile" >
                <i class="ni ni-single-02 text-info"></i>
                <span class="nav-link-text">Profile</span>
              </a>
            </li>
            <li class="nav-item <?php if($this->uri->segment(3) == 'gst'){ ?>active_live <?php } ?>"">
              <a class="nav-link" href="<?php echo base_url(); ?>View/setting/gst">
            ...
            <li class="nav-item <?php if($this->uri->segment(3) == 'smtp'){ ?>active_live <?php } ?>"">
              <a class="nav-link" href="<?php echo base_url(); ?>View/setting/smtp">
